WEBSITE DROP-DOWN SUBMENUS HORIZONTALLY EMBEDDED UNDER AN ITEM OF MAIN MENU, WITH ALTERNATING OF EVOKED TARGET
 ...
 n-th submenu: drop-down submenu expanded from an item of (n-1)st submenu - items in a row embedded under the SAME item of MAIN menu
